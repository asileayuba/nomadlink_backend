...
class KYC(models.Model):
    ...
    id_document = models.FileField(upload_to='kyc/documents/', blank=True, null=True, validators=[validate_file_pdf_only])
    id_document_file_type = models.CharField(max_length=50, blank=True, null=True)
    id_document_file_size = models.PositiveIntegerField(blank=True, null=True)  # bytes

    selfie_photo = models.ImageField(upload_to='kyc/selfies/', blank=True, null=True, validators=[validate_image_size])
    selfie_file_type = models.CharField(max_length=50, blank=True, null=True)
    selfie_file_size = models.PositiveIntegerField(blank=True, null=True)  # bytes
